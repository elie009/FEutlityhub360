...
const Bills: React.FC = () => {
  ...
  // Group bills by billName to show only the most recent one per bill
  const groupedBills = React.useMemo(() => {
    return bills.reduce((acc, bill) => {
      ...
      if (!acc[key]) {
        ...
        // Keep the most recent bill (latest due date)
        const currentLatest = new Date(acc[key].latestBill.dueDate);
        const newBill = new Date(bill.dueDate);
        
        if (newBill > currentLatest) {
