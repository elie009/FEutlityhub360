...
export interface ChatbotResponse {
  ...
  /** When present, user can download a PDF generated by the server (financial report). */
...
export class ChatbotService {
  ...
  async sendAIMessage(
    ...
    try {
      ...
      let pdfAttachment: { fileName: string; base64: string } | undefined;
      if (data.hasPdfAttachment && data.pdfAttachmentBase64 && data.pdfFileName) {
        pdfAttachment = {
          fileName: data.pdfFileName,
          base64: data.pdfAttachmentBase64,
        };
      }
